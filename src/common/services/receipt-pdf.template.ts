          ...
          React.createElement(
            ...
            React.createElement(
              ...
              isPix
                ...
                : // Cartão (qualquer método não-PIX): ícone genérico azul, mesmo
                  // do organizador (`CreditCardIcon.tsx`). Não usa mais a bandeira
                  // real — padrão unificado desde a troca dos ícones de cartão.
                  React.createElement(
                    Svg,
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        LinearGradient,
                        {
                          id: 'ccGrad',
                          x1: '32.5', y1: '-0.239257',
                          x2: '0.937501', y2: '19.7607',
                          gradientUnits: 'userSpaceOnUse',
                        },
                        React.createElement(Stop, { offset: 0, stopColor: '#3DB9CF' }),
                        React.createElement(Stop, { offset: 1, stopColor: '#107D98' }),
                      ),
                    ),
                    React.createElement(Path, {
                    ...
                    React.createElement(Path, {
                      d: 'M31.9798 4.29297H0V7.91196H31.9798V4.29297Z',
                      fill: '#202020',
                    }),
                    React.createElement(Path, {
